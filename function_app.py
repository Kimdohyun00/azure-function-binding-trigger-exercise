...
@app.event_hub_message_trigger(arg_name="azeventhub", event_hub_name="test-hub",
                               connection="dt007eventhub_RootManageSharedAccessKey_EVENTHUB") 
...
#     arg_name="event", event_hub_name="test-hub", connection="dt007eventhub_RootManageSharedAccessKey_EVENTHUB"
# )
